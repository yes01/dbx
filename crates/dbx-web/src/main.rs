...
async fn main() {
    ...
    let api = Router::new()
        ...
        .route("/document-store/list-gridfs-buckets", post(routes::mongo::list_gridfs_buckets))
        .route("/document-store/create-gridfs-bucket", post(routes::mongo::create_gridfs_bucket))
        .route("/document-store/delete-gridfs-bucket", post(routes::mongo::delete_gridfs_bucket))
        .route("/document-store/list-gridfs-files", post(routes::mongo::list_gridfs_files))
        .route("/document-store/download-gridfs-file", post(routes::mongo::download_gridfs_file))
        .route("/document-store/upload-gridfs-file", post(routes::mongo::upload_gridfs_file))
        .route("/document-store/delete-gridfs-file", post(routes::mongo::delete_gridfs_file))
