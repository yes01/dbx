...
<Tabs groupId="platform" items={['macOS', 'Windows', 'Linux', 'Docker']}>
  <Tab value="macOS">
    ...
    You can also download a `.dmg` installer from the internal release channel.
  </Tab>
  <Tab value="Windows">
    Install with Scoop:
    ...
    You can also download a `.msi` installer from the internal release channel.
  </Tab>
  <Tab value="Linux">
    Download a package from the internal release channel:
