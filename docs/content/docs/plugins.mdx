...
Check whether your network can access DBX internal release channel. TestTeam DBX uses internal release channels for plugin downloads. Check internal network access if downloads fail.
