export default {
  ...
  grid: {
    ...
    filterBuilderNoMatchingColumns: "No hay columnas coincidentes",
    ...
    searchColumns: "Buscar columnas/comentarios...",
    ...
    copyRowsInsertWithoutPrimaryKeysMerged: "Copiar {count} filas como INSERT combinado sin claves primarias",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copiar {count} filas como INSERT fila por fila sin claves primarias",
  ...
  contextMenu: {
    ...
    damengJobAdmin: "Jobs de Dameng",
    openDamengJobAdmin: "Abrir jobs de Dameng",
    newQuery: "Nueva consulta",
    newSql: "Nuevo SQL",
    ...
    dropTableCascadeHint: "También elimina objetos dependientes, como vistas. Déjalo desactivado para usar el comportamiento restrictivo predeterminado de la base de datos.",
  ...
  transfer: {
    ...
    ownershipTitle: "Faltan owners de PostgreSQL",
    ownershipMessage: "La base de datos de destino no tiene estos roles owner: {owners}.",
    ownershipSkipDetails: "Puedes omitir la restauración de owners o reasignar los owners faltantes al usuario actual de destino.",
    ownershipTargetOwner: "Los owners faltantes se reasignarán a: {owner}",
    ownershipSkip: "Omitir owners",
    ownershipConfirm: "Reasignar y continuar",
  },
  tableImport: {
    title: "Importar datos a tabla",
    target: "Tabla destino",
    targetMode: "Modo de destino",
    existingTable: "Tabla existente",
  ...
  damengJobAdmin: {
    title: "Jobs de Dameng",
    unsupported: "La administración de jobs solo está disponible para conexiones Dameng.",
    environmentMissing: "El entorno de jobs de Dameng no está inicializado para esta conexión.",
    initEnvironment: "Inicializar entorno de jobs",
    newJob: "Nuevo job",
    searchJob: "Buscar jobs",
    emptyJobs: "No hay jobs",
    ...
    apply: "Aplicar",
    applySuccess: "Operación de job aplicada",
