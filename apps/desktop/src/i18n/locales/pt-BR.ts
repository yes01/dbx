export default {
  ...
  grid: {
    ...
    filterBuilderSearchColumns: "Buscar colunas...",
    filterBuilderNoMatchingColumns: "Nenhuma coluna correspondente",
    ...
    searchColumns: "Pesquisar colunas/comentarios...",
    ...
    copyRowsInsertRowByRow: "Copiar {count} Linhas como INSERT linha a linha",
    copyRowsInsertWithoutPrimaryKeys: "Copiar {count} Linhas como INSERT sem Chaves Primárias",
    copyRowsInsertWithoutPrimaryKeysMerged: "Copiar {count} Linhas como INSERT mesclado sem Chaves Primárias",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copiar {count} Linhas como INSERT linha a linha sem Chaves Primárias",
  ...
  contextMenu: {
    ...
    damengJobAdmin: "Jobs Dameng",
    openDamengJobAdmin: "Abrir jobs Dameng",
    newQuery: "Nova Consulta",
    newSql: "Novo SQL",
    ...
    dropTableCascadeHint: "Também remove objetos dependentes, como views. Deixe desativado para usar o comportamento restritivo padrão do banco de dados.",
  ...
  transfer: {
    ...
    ownershipTitle: "Owners PostgreSQL ausentes",
    ownershipMessage: "O banco de destino não possui estes papéis owner: {owners}.",
    ownershipSkipDetails: "Você pode ignorar a restauração de owners ou reatribuir os owners ausentes ao usuário atual do banco de destino.",
    ownershipTargetOwner: "Os owners ausentes serão reatribuídos para: {owner}",
    ownershipSkip: "Ignorar owners",
    ownershipConfirm: "Reatribuir e continuar",
  },
  tableImport: {
    title: "Importar Dados da Tabela",
    target: "Tabela de destino",
    targetMode: "Modo de destino",
    existingTable: "Tabela existente",
    createTable: "Criar nova tabela",
    newTableName: "Nome da nova tabela",
    newTableNamePlaceholder: "imported_data",
  ...
  damengJobAdmin: {
    title: "Jobs Dameng",
    unsupported: "A administração de jobs está disponível apenas para conexões Dameng.",
    environmentMissing: "O ambiente de jobs Dameng não está inicializado para esta conexão.",
    initEnvironment: "Inicializar ambiente de jobs",
    newJob: "Novo job",
    searchJob: "Pesquisar jobs",
    emptyJobs: "Nenhum job",
    emptyDetails: "Sem detalhes",
    enabled: "Ativado",
    disabled: "Desativado",
    running: "Em execução",
    run: "Executar",
