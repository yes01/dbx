export default {
  ...
  grid: {
    ...
    searchColumns: "Search columns/comments...",
    ...
    copyRowsInsertMerged: "Copy {count} Rows as merged INSERT",
    copyRowsInsertRowByRow: "Copy {count} Rows as row-by-row INSERT",
    copyRowsInsertWithoutPrimaryKeys: "Copy {count} Rows as INSERT without Primary Keys",
    copyRowsInsertWithoutPrimaryKeysMerged: "Copy {count} Rows as merged INSERT without Primary Keys",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copy {count} Rows as row-by-row INSERT without Primary Keys",
  ...
  contextMenu: {
    ...
    damengJobAdmin: "Dameng Jobs",
    openDamengJobAdmin: "Open Dameng Jobs",
    ...
    dropTableCascadeHint: "Also drop dependent objects such as views. Leave off to use the database default restrict behavior.",
  ...
  extension: {
    ...
    install: "Install",
    drop: "Drop",
    noAvailable: "No available extensions",
  ...
  damengJobAdmin: {
    title: "Dameng Jobs",
    unsupported: "Dameng job administration is only available for Dameng connections.",
    environmentMissing: "The Dameng job environment is not initialized for this connection.",
  ...
  zookeeper: {
    ...
    rootReadonly: "Root znode cannot be created or edited",
    saved: "Znode saved",
  ...
  transfer: {
    ...
    ownershipTitle: "Missing PostgreSQL owners",
    ownershipMessage: "The target database does not have these owner roles: {owners}.",
    ownershipSkipDetails: "You can skip owner restoration or reassign missing owners to the current target database user.",
    ownershipTargetOwner: "Missing owners will be reassigned to: {owner}",
    ownershipSkip: "Skip owners",
    ownershipConfirm: "Reassign and continue",
  },
  tableImport: {
