export default {
  ...
  grid: {
    ...
    filterBuilderSearchColumns: "列を検索...",
    filterBuilderNoMatchingColumns: "一致する列がありません",
    ...
    copyRowsInsertMerged: "{count}行を結合INSERTとしてコピー",
    copyRowsInsertRowByRow: "{count}行を行ごとのINSERTとしてコピー",
    copyRowsInsertWithoutPrimaryKeys: "{count}行を主キーなしでINSERTとしてコピー",
    copyRowsInsertWithoutPrimaryKeysMerged: "{count}行を主キーなしの結合INSERTとしてコピー",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "{count}行を主キーなしの行ごとのINSERTとしてコピー",
  ...
  contextMenu: {
    ...
    damengJobAdmin: "Damengジョブ",
    openDamengJobAdmin: "Damengジョブを開く",
    ...
    dropTableCascadeHint: "ビューなどの依存オブジェクトも削除します。オフの場合はデータベース既定の制限動作を使用します。",
  ...
  damengJobAdmin: {
    title: "Damengジョブ",
    unsupported: "Damengジョブ管理はDameng接続でのみ利用できます。",
    environmentMissing: "この接続ではDamengジョブ環境が初期化されていません。",
    initEnvironment: "ジョブ環境を初期化",
    newJob: "新規ジョブ",
    searchJob: "ジョブを検索",
    emptyJobs: "ジョブがありません",
    emptyDetails: "詳細がありません",
    enabled: "有効",
    disabled: "無効",
    running: "実行中",
    run: "実行",
  ...
  transfer: {
    ...
    dataTransfer: "データ転送",
    ownershipTitle: "PostgreSQL owner がありません",
    ownershipMessage: "ターゲットデータベースに次の owner ロールがありません: {owners}。",
    ownershipSkipDetails: "owner の復元をスキップするか、存在しない owner をターゲットデータベースの現在のユーザーに再割り当てできます。",
    ownershipTargetOwner: "存在しない owner の再割り当て先: {owner}",
    ownershipSkip: "Owner をスキップ",
    ownershipConfirm: "再割り当てして続行",
  },
  tableImport: {
    title: "テーブルデータをインポート",
    target: "対象テーブル",
    targetMode: "対象モード",
    existingTable: "既存テーブルへインポート",
    createTable: "新しいテーブルを作成してインポート",
