export default {
  ...
  grid: {
    ...
    filterBuilderSearchColumns: "Cerca colonne...",
    filterBuilderNoMatchingColumns: "Nessuna colonna corrispondente",
    ...
    searchColumns: "Cerca colonne/commenti...",
    ...
    copyRowsInsertWithoutPrimaryKeysMerged: "Copia {count} Righe come INSERT unito senza Chiavi Primarie",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "Copia {count} Righe come INSERT riga per riga senza Chiavi Primarie",
  ...
  contextMenu: {
    ...
    damengJobAdmin: "Job Dameng",
    openDamengJobAdmin: "Apri Job Dameng",
    newQuery: "Nuova Query",
    newSql: "Nuovo SQL",
    ...
    dropTableCascadeHint: "Elimina anche gli oggetti dipendenti, come le viste. Lascia disattivato per usare il comportamento restrittivo predefinito del database.",
  ...
  transfer: {
    ...
    ownershipTitle: "Owner PostgreSQL mancanti",
    ownershipMessage: "Il database di destinazione non contiene questi ruoli owner: {owners}.",
    ownershipSkipDetails: "Puoi saltare il ripristino degli owner o riassegnare gli owner mancanti all'utente corrente del database di destinazione.",
    ownershipTargetOwner: "Gli owner mancanti saranno riassegnati a: {owner}",
    ownershipSkip: "Salta owner",
    ownershipConfirm: "Riassegna e continua",
  },
  tableImport: {
    title: "Importa Dati Tabella",
    target: "Tabella di destinazione",
    targetMode: "Modalita destinazione",
    existingTable: "Tabella esistente",
    createTable: "Crea nuova tabella",
    newTableName: "Nome nuova tabella",
  ...
  damengJobAdmin: {
    title: "Job Dameng",
    unsupported: "La gestione job è disponibile solo per connessioni Dameng.",
    environmentMissing: "L'ambiente job Dameng non è inizializzato per questa connessione.",
    initEnvironment: "Inizializza ambiente job",
    newJob: "Nuovo job",
    searchJob: "Cerca job",
    emptyJobs: "Nessun job",
    emptyDetails: "Nessun dettaglio",
    enabled: "Abilitato",
    ...
    endTime: "Ora fine",
    minuteInterval: "Intervallo minuti",
