export default {
  ...
  grid: {
    ...
    filterBuilderNoMatchingColumns: "沒有符合的欄位",
    ...
    copyRowsInsertMerged: "複製 {count} 筆為合併 INSERT",
    copyRowsInsertRowByRow: "複製 {count} 筆為逐筆 INSERT",
    copyRowsInsertWithoutPrimaryKeys: "複製 {count} 筆為 INSERT（不含主鍵）",
    copyRowsInsertWithoutPrimaryKeysMerged: "複製 {count} 筆為合併 INSERT（不含主鍵）",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "複製 {count} 筆為逐筆 INSERT（不含主鍵）",
  ...
  contextMenu: {
    ...
    dropTableCascadeHint: "同時刪除依賴此資料表的物件（例如檢視）。未勾選時使用資料庫預設限制行為。",
  ...
  transfer: {
    ...
    dataTransfer: "資料傳輸",
    ownershipTitle: "目標庫缺少 PostgreSQL Owner",
    ownershipMessage: "目標資料庫不存在這些 owner 角色：{owners}。",
    ownershipSkipDetails: "可以略過 owner 還原，也可以把缺少的 owner 重新指定為目標資料庫目前使用者。",
    ownershipTargetOwner: "缺少的 owner 將重新指定為：{owner}",
    ownershipSkip: "略過 Owner",
    ownershipConfirm: "重新指定並繼續",
  },
  tableImport: {
    title: "匯入資料表資料",
    target: "目標資料表",
    targetMode: "目標模式",
    existingTable: "匯入到既有資料表",
    createTable: "建立新資料表並匯入",
    newTableName: "新資料表名稱",
  ...
  damengJobAdmin: {
    title: "達夢作業",
    unsupported: "達夢作業管理僅支援達夢連線。",
    environmentMissing: "目前連線尚未初始化達夢作業環境。",
