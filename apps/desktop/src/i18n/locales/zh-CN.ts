export default {
  ...
  grid: {
    ...
    copyRowsInsertMerged: "复制 {count} 行为合并 INSERT",
    copyRowsInsertRowByRow: "复制 {count} 行为逐行 INSERT",
    copyRowsInsertWithoutPrimaryKeys: "复制 {count} 行为 INSERT（不含主键）",
    copyRowsInsertWithoutPrimaryKeysMerged: "复制 {count} 行为合并 INSERT（不含主键）",
    copyRowsInsertWithoutPrimaryKeysRowByRow: "复制 {count} 行为逐行 INSERT（不含主键）",
  ...
  contextMenu: {
    ...
    dropTableCascadeHint: "同时删除依赖该表的对象（如视图）。未勾选时使用数据库默认限制行为。",
  ...
  extension: {
    ...
    install: "安装",
    drop: "删除",
    noAvailable: "没有可安装的扩展",
    noInstalled: "没有已安装的扩展",
  },
  userAdmin: {
    title: "用户与权限",
  ...
  damengJobAdmin: {
    title: "达梦作业",
    unsupported: "达梦作业管理仅支持达梦连接。",
    environmentMissing: "当前连接尚未初始化达梦作业环境。",
  ...
  transfer: {
    ...
    ownershipTitle: "目标库缺少 PostgreSQL Owner",
    ownershipMessage: "目标数据库不存在这些 owner 角色：{owners}。",
    ownershipSkipDetails: "可以跳过 owner 恢复，也可以把缺失 owner 重映射为目标数据库当前用户。",
    ownershipTargetOwner: "缺失 owner 将重映射为：{owner}",
    ownershipSkip: "跳过 Owner",
    ownershipConfirm: "重映射并继续",
  },
  tableImport: {
    title: "导入表数据",
    target: "目标表",
    targetMode: "目标模式",
    existingTable: "导入到已有表",
    createTable: "新建表并导入",
    newTableName: "新表名称",
