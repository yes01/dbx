...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::mongo_cmd::document_list_gridfs_buckets,
            commands::mongo_cmd::document_create_gridfs_bucket,
            commands::mongo_cmd::document_delete_gridfs_bucket,
            commands::mongo_cmd::document_list_gridfs_files,
            commands::mongo_cmd::document_download_gridfs_file,
            commands::mongo_cmd::document_upload_gridfs_file,
            commands::mongo_cmd::document_delete_gridfs_file,
